...
import { Download, FileSpreadsheetIcon, FileTextIcon, Search, Filter } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const OrderTableFilters: FC<OrderTableFiltersProps> = ({ searchQuery, setSearchQuery, onExport, variant, onFilter }) => {
